...
на панели слева выбираем вкладку "Триггеры"

на 1 триггер только 1 функция

справа-сверху добавить

даем говорящее имя, желательно как функция с припиской что это таймер

тип - таймер

cron-выражение - 0 */2 ? * * * (каждые 2 часа), 0 * ? * * * (каждый час), выбирать исходя из работы

выбрать функцию

Сервисный аккаунт - ban-show-api-tool-2
